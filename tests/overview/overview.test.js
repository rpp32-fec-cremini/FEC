...
//   // var cartEl = getByTestId('cart');
//   // var styleEl = getByTestId('style');
//   // var productEl = getByTestId('prodInfo');
//   // var imageEl = getByTestId('practice-img');
//   // var overviewEl = getByTestId('overview');
