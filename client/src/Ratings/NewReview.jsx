...
var Character = ({ choice, theme, charMap }) => {
  ...
  return (
    <div>
      <div style={{ height: "5px", fontSize: "10px", fontStyle: "italic" }}>
        {meaning}
      </div>
...
var ReviewBody = (props) => {
  ...
  return (
    <div>
      ...
      />
      <div className="warning" id="counter">
        {count >= 50
          ? "Minimum reached"
          : `Minimum required characters left: ${50 - count}`}
      </div>
    </div>
  );
};
...
var NewReview = ({
  ...
  return writing ? (
    <div className="newReview" onClick={(e) => clicked(e)}>
          ...
          <div
            ...
            onClick={async (e) => {
              ...
              if (
                rating === undefined ||
                recommend === undefined ||
                chars.length !== Object.keys(characteristics).length ||
                body.length < 50 ||
                !name.length ||
                !email.length ||
                ...
                if (!submitted) {
                  var errorMessage = $(`<div id="error" data-testid="error">
